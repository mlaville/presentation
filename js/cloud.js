...
//            o.span.style.left = o.screenX - o.width * o.factor / 2; // hack
            o.span.style.left = o.screenX - o.width * o.factor / 2 + 'px'; // hack
            o.screenY = h * (o.y * yScale + 1) / 2;
//            o.span.style.top = o.screenY - o.height * o.factor / 2; // hack
            o.span.style.top = o.screenY - o.height * o.factor / 2 + 'px'; // hack
    ...
    function setClosest(obj) {
        ...
        if (closest != null) {
            closest.span.style.border = "1px solid #999";
        } // if
